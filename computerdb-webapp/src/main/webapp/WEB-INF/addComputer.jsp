...
<section id="main">
	...
	<form:form action="${pageContext.request.contextPath}/Computer/Save" method="POST"
		...
		<div class="actions">
			...
			or <a href="${pageContext.request.contextPath}/Computer/Search" class="btn"><spring:message
					code="cancelButton" /></a>
