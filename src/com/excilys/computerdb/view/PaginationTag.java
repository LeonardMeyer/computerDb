	...
	public int doStartTag(){
		...
		try {
			...
			for (int i = 1; i < nbOfPages+1; i++) {
				if (i == 1) {
					out.println("<li><a href='/computer-database/Computers?firstBound=0&secondBound="+recordsPerPage+"'>1</a></li>");
				}else {
					out.println("<li><a href='/computer-database/Computers?firstBound="+previousBound+
